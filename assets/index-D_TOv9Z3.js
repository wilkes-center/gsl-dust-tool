 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qh;function Rp(){if(qh)return ut;qh=1;var l=Symbol.for("react.transitional.element"),o=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),g=Symbol.for("react.consumer"),m=Symbol.for("react.context"),v=Symbol.for("react.forward_ref"),S=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),T=Symbol.for("react.lazy"),D=Symbol.iterator;function H(b){return b===null||typeof b!="object"?null:(b=D&&b[D]||b["@@iterator"],typeof b=="function"?b:null)}var L={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,P={};function et(b,C,B){this.props=b,this.context=C,this.refs=P,this.updater=B||L}et.prototype.isReactComponent={},et.prototype.setState=function(b,C){if(typeof b!="object"&&typeof b!="function"&&b!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,b,C,"setState")},et.prototype.forceUpdate=function(b){this.updater.enqueueForceUpdate(this,b,"forceUpdate")};function it(){}it.prototype=et.prototype;function lt(b,C,B){this.props=b,this.context=C,this.refs=P,this.updater=B||L}var J=lt.prototype=new it;J.constructor=lt,Z(J,et.prototype),J.isPureReactComponent=!0;var V=Array.isArray,X={H:null,A:null,T:null,S:null,V:null},q=Object.prototype.hasOwnProperty;function Y(b,C,B,G,K,ot){return B=ot.ref,{$$typeof:l,type:b,key:C,ref:B!==void 0?B:null,props:ot}}function ht(b,C){return Y(b.type,C,void 0,void 0,void 0,b.props)}function Kt(b){return typeof b=="object"&&b!==null&&b.$$typeof===l}function qe(b){var C={"=":"=0",":":"=2"};return"$"+b.replace(/[=:]/g,function(B){return C[B]})}var ce=/\/+/g;function Nt(b,C){return typeof b=="object"&&b!==null&&b.key!=null?qe(""+b.key):C.toString(36)}function Ce(){}function $e(b){switch(b.status){case"fulfilled":return b.value;case"rejected":throw b.reason;default:switch(typeof b.status=="string"?b.then(Ce,Ce):(b.status="pending",b.then(function(C){b.status==="pending"&&(b.status="fulfilled",b.value=C)},function(C){b.status==="pending"&&(b.status="rejected",b.reason=C)})),b.status){case"fulfilled":return b.value;case"rejected":throw b.reason}}throw b}function Ut(b,C,B,G,K){var ot=typeof b;(ot==="undefined"||ot==="boolean")&&(b=null);var F=!1;if(b===null)F=!0;else switch(ot){case"bigint":case"string":case"number":F=!0;break;case"object":switch(b.$$typeof){case l:case o:F=!0;break;case T:return F=b._init,Ut(F(b._payload),C,B,G,K)}}if(F)return K=K(b),F=G===""?"."+Nt(b,0):G,V(K)?(B="",F!=null&&(B=F.replace(ce,"$&/")+"/"),Ut(K,C,B,"",function(zt){return zt})):K!=null&&(Kt(K)&&(K=ht(K,B+(K.key==null||b&&b.key===K.key?"":(""+K.key).replace(ce,"$&/")+"/")+F)),C.push(K)),1;F=0;var Dt=G===""?".":G+":";if(V(b))for(var mt=0;mt<b.length;mt++)G=b[mt],ot=Dt+Nt(G,mt),F+=Ut(G,C,B,ot,K);else if(mt=H(b),typeof mt=="function")for(b=mt.call(b),mt=0;!(G=b.next()).done;)G=G.value,ot=Dt+Nt(G,mt++),F+=Ut(G,C,B,ot,K);else if(ot==="object"){if(typeof b.then=="function")return Ut($e(b),C,B,G,K);throw C=String(b),Error("Objects are not valid as a React child (found: "+(C==="[object Object]"?"object with keys {"+Object.keys(b).join(", ")+"}":C)+"). If you meant to render a collection of children, use an array instead.")}return F}function M(b,C,B){if(b==null)return b;var G=[],K=0;return Ut(b,G,"","",function(ot){return C.call(B,ot,K++)}),G}function U(b){if(b._status===-1){var C=b._result;C=C(),C.then(function(B){(b._status===0||b._status===-1)&&(b._status=1,b._result=B)},function(B){(b._status===0||b._status===-1)&&(b._status=2,b._result=B)}),b._status===-1&&(b._status=0,b._result=C)}if(b._status===1)return b._result.default;throw b._result}var k=typeof reportError=="function"?reportError:function(b){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var C=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof b=="object"&&b!==null&&typeof b.message=="string"?String(b.message):String(b),error:b});if(!window.dispatchEvent(C))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",b);return}console.error(b)};function nt(){}return ut.Children={map:M,forEach:function(b,C,B){M(b,function(){C.apply(this,arguments)},B)},count:function(b){var C=0;return M(b,function(){C++}),C},toArray:function(b){return M(b,function(C){return C})||[]},only:function(b){if(!Kt(b))throw Error("React.Children.only expected to receive a single React element child.");return b}},ut.Component=et,ut.Fragment=c,ut.Profiler=f,ut.PureComponent=lt,ut.StrictMode=r,ut.Suspense=S,ut.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,ut.__COMPILER_RUNTIME={__proto__:null,c:function(b){return X.H.useMemoCache(b)}},ut.cache=function(b){return function(){return b.apply(null,arguments)}},ut.cloneElement=function(b,C,B){if(b==null)throw Error("The argument must be a React element, but you passed "+b+".");var G=Z({},b.props),K=b.key,ot=void 0;if(C!=null)for(F in C.ref!==void 0&&(ot=void 0),C.key!==void 0&&(K=""+C.key),C)!q.call(C,F)||F==="key"||F==="__self"||F==="__source"||F==="ref"&&C.ref===void 0||(G[F]=C[F]);var F=arguments.length-2;if(F===1)G.children=B;else if(1<F){for(var Dt=Array(F),mt=0;mt<F;mt++)Dt[mt]=arguments[mt+2];G.children=Dt}return Y(b.type,K,void 0,void 0,ot,G)},ut.createContext=function(b){return b={$$typeof:m,_currentValue:b,_currentValue2:b,_threadCount:0,Provider:null,Consumer:null},b.Provider=b,b.Consumer={$$typeof:g,_context:b},b},ut.createElement=function(b,C,B){var G,K={},ot=null;if(C!=null)for(G in C.key!==void 0&&(ot=""+C.key),C)q.call(C,G)&&G!=="key"&&G!=="__self"&&G!=="__source"&&(K[G]=C[G]);var F=arguments.length-2;if(F===1)K.children=B;else if(1<F){for(var Dt=Array(F),mt=0;mt<F;mt++)Dt[mt]=arguments[mt+2];K.children=Dt}if(b&&b.defaultProps)for(G in F=b.defaultProps,F)K[G]===void 0&&(K[G]=F[G]);return Y(b,ot,void 0,void 0,null,K)},ut.createRef=function(){return{current:null}},ut.forwardRef=function(b){return{$$typeof:v,render:b}},ut.isValidElement=Kt,ut.lazy=function(b){return{$$typeof:T,_payload:{_status:-1,_result:b},_init:U}},ut.memo=function(b,C){return{$$typeof:p,type:b,compare:C===void 0?null:C}},ut.startTransition=function(b){var C=X.T,B={};X.T=B;try{var G=b(),K=X.S;K!==null&&K(B,G),typeof G=="object"&&G!==null&&typeof G.then=="function"&&G.then(nt,k)}catch(ot){k(ot)}finally{X.T=C}},ut.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},ut.use=function(b){return X.H.use(b)},ut.useActionState=function(b,C,B){return X.H.useActionState(b,C,B)},ut.useCallback=function(b,C){return X.H.useCallback(b,C)},ut.useContext=function(b){return X.H.useContext(b)},ut.useDebugValue=function(){},ut.useDeferredValue=function(b,C){return X.H.useDeferredValue(b,C)},ut.useEffect=function(b,C,B){var G=X.H;if(typeof B=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return G.useEffect(b,C)},ut.useId=function(){return X.H.useId()},ut.useImperativeHandle=function(b,C,B){return X.H.useImperativeHandle(b,C,B)},ut.useInsertionEffect=function(b,C){return X.H.useInsertionEffect(b,C)},ut.useLayoutEffect=function(b,C){return X.H.useLayoutEffect(b,C)},ut.useMemo=function(b,C){return X.H.useMemo(b,C)},ut.useOptimistic=function(b,C){return X.H.useOptimistic(b,C)},ut.useReducer=function(b,C,B){return X.H.useReducer(b,C,B)},ut.useRef=function(b){return X.H.useRef(b)},ut.useState=function(b){return X.H.useState(b)},ut.useSyncExternalStore=function(b,C,B){return X.H.useSyncExternalStore(b,C,B)},ut.useTransition=function(){return X.H.useTransition()},ut.version="19.1.0",ut}var Gh;function Bc(){return Gh||(Gh=1,pc.exports=Rp()),pc.exports}var N=Bc();const Le=wp(N);var yc={exports:{}},ui={},bc={exports:{}},vc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kh;function Dp(){return kh||(kh=1,function(l){function o(M,U){var k=M.length;M.push(U);t:for(;0<k;){var nt=k-1>>>1,b=M[nt];if(0<f(b,U))M[nt]=U,M[k]=b,k=nt;else break t}}function c(M){return M.length===0?null:M[0]}function r(M){if(M.length===0)return null;var U=M[0],k=M.pop();if(k!==U){M[0]=k;t:for(var nt=0,b=M.length,C=b>>>1;nt<C;){var B=2*(nt+1)-1,G=M[B],K=B+1,ot=M[K];if(0>f(G,k))K<b&&0>f(ot,G)?(M[nt]=ot,M[K]=k,nt=K):(M[nt]=G,M[B]=k,nt=B);else if(K<b&&0>f(ot,k))M[nt]=ot,M[K]=k,nt=K;else break t}}return U}function f(M,U){var k=M.sortIndex-U.sortIndex;return k!==0?k:M.id-U.id}if(l.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var m=Date,v=m.now();l.unstable_now=function(){return m.now()-v}}var S=[],p=[],T=1,D=null,H=3,L=!1,Z=!1,P=!1,et=!1,it=typeof setTimeout=="function"?setTimeout:null,lt=typeof clearTimeout=="function"?clearTimeout:null,J=typeof setImmediate<"u"?setImmediate:null;function V(M){for(var U=c(p);U!==null;){if(U.callback===null)r(p);else if(U.startTime<=M)r(p),U.sortIndex=U.expirationTime,o(S,U);else break;U=c(p)}}function X(M){if(P=!1,V(M),!Z)if(c(S)!==null)Z=!0,q||(q=!0,Nt());else{var U=c(p);U!==null&&Ut(X,U.startTime-M)}}var q=!1,Y=-1,ht=5,Kt=-1;function qe(){return et?!0:!(l.unstable_now()-Kt<ht)}function ce(){if(et=!1,q){var M=l.unstable_now();Kt=M;var U=!0;try{t:{Z=!1,P&&(P=!1,lt(Y),Y=-1),L=!0;var k=H;try{e:{for(V(M),D=c(S);D!==null&&!(D.expirationTime>M&&qe());){var nt=D.callback;if(typeof nt=="function"){D.callback=null,H=D.priorityLevel;var b=nt(D.expirationTime<=M);if(M=l.unstable_now(),typeof b=="function"){D.callback=b,V(M),U=!0;break e}D===c(S)&&r(S),V(M)}else r(S);D=c(S)}if(D!==null)U=!0;else{var C=c(p);C!==null&&Ut(X,C.startTime-M),U=!1}}break t}finally{D=null,H=k,L=!1}U=void 0}}finally{U?Nt():q=!1}}}var Nt;if(typeof J=="function")Nt=function(){J(ce)};else if(typeof MessageChannel<"u"){var Ce=new MessageChannel,$e=Ce.port2;Ce.port1.onmessage=ce,Nt=function(){$e.postMessage(null)}}else Nt=function(){it(ce,0)};function Ut(M,U){Y=it(function(){M(l.unstable_now())},U)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(M){M.callback=null},l.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ht=0<M?Math.floor(1e3/M):5},l.unstable_getCurrentPriorityLevel=function(){return H},l.unstable_next=function(M){switch(H){case 1:case 2:case 3:var U=3;break;default:U=H}var k=H;H=U;try{return M()}finally{H=k}},l.unstable_requestPaint=function(){et=!0},l.unstable_runWithPriority=function(M,U){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var k=H;H=M;try{return U()}finally{H=k}},l.unstable_scheduleCallback=function(M,U,k){var nt=l.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?nt+k:nt):k=nt,M){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=k+b,M={id:T++,callback:U,priorityLevel:M,startTime:k,expirationTime:b,sortIndex:-1},k>nt?(M.sortIndex=k,o(p,M),c(S)===null&&M===c(p)&&(P?(lt(Y),Y=-1):P=!0,Ut(X,k-nt))):(M.sortIndex=b,o(S,M),Z||L||(Z=!0,q||(q=!0,Nt()))),M},l.unstable_shouldYield=qe,l.unstable_wrapCallback=function(M){var U=H;return function(){var k=H;H=U;try{return M.apply(this,arguments)}finally{H=k}}}}(vc)),vc}var Yh;function Cp(){return Yh||(Yh=1,bc.exports=Dp()),bc.exports}var xc={exports:{}},te={};/**
 * @license React
...
`;const R1="pk.eyJ1IjoicGt1bGFuZGgiLCJhIjoiY20xNGZqbDBiMHhmdzJucHd5OTA4d2h2bCJ9.J6GeFa6bPfwMKqufI9L3MA",D1={styleUrl:"mapbox://styles/pkulandh/cm9iyi6qq00jo01rce7xjcfay"},C1=l=>l<=.3?"#feb24c":l<=.6?"#fc4e2a":l<=.94?"#bd0026":"#800026",$1=R.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  width: 100%;
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vb=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]],Ag=un("circle-help",vb);/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mb=[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]],Ab=un("message-square",Mb);/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wb=[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]],jb=un("play",wb),Ob=({onComplete:l})=>{const[o,c]=N.useState("about");return h.jsxs(Rb,{children:[h.jsxs(Db,{children:[h.jsx(Cb,{}),h.jsx($b,{})]}),h.jsxs(Nb,{children:[h.jsxs(Ub,{children:[h.jsxs(Hb,{children:[h.jsx(Lb,{children:h.jsx("img",{src:"/gsl-dust-tool/logo192.png",alt:"GSL Dust Tool Logo",className:"w-full h-full object-contain rounded-md"})}),h.jsxs(Bb,{children:[h.jsx(qb,{children:"GSL"})," Dust Forecast Tool"]})]}),h.jsx(Gb,{children:h.jsxs(kb,{onClick:l,children:[h.jsx(zb,{size:20,className:"mr-2"}),"Enter Map"]})}),h.jsx(Yb,{children:h.jsxs(Xb,{children:[h.jsxs(Ac,{active:o==="about",onClick:()=>c("about"),children:[h.jsx(Tb,{size:20,className:"mr-3"}),h.jsx("span",{children:"About"}),o==="about"&&h.jsx(wc,{})]}),h.jsxs(Ac,{active:o==="howto",onClick:()=>c("howto"),children:[h.jsx(Ag,{size:20,className:"mr-3"}),h.jsx("span",{children:"How to Use"}),o==="howto"&&h.jsx(wc,{})]}),h.jsxs(Ac,{active:o==="feedback",onClick:()=>c("feedback"),children:[h.jsx(Ab,{size:20,className:"mr-3"}),h.jsx("span",{children:"Feedback"}),o==="feedback"&&h.jsx(wc,{})]})]})})]}),h.jsxs(Zb,{children:[o==="about"&&h.jsxs(Qb,{children:[h.jsxs(Yu,{children:[h.jsx(Uu,{children:"About This Tool"}),h.jsx(Hu,{})]}),h.jsxs(Yu,{children:[h.jsx(Uu,{children:"Understanding PM10"}),h.jsx(Hu,{}),h.jsx(wg,{children:"PM10 refers to coarse particulate matter with a diameter of 10 micrometers or smaller. These particles can settle in the bronchi and lungs, potentially causing health problems particularly for people with respiratory conditions."}),h.jsxs("div",{children:[h.jsx(Jb,{children:"PM10 Levels"}),h.jsxs(Wb,{children:[h.jsx(Fb,{}),h.jsxs(Pb,{children:[h.jsxs(Kl,{children:[h.jsx(Jl,{color:"#00d600",children:"Good"}),h.jsx(Wl,{children:"0-54 μg/m³"})]}),h.jsxs(Kl,{children:[h.jsx(Jl,{color:"#ffee00",children:"Moderate"}),h.jsx(Wl,{children:"55-154"})]}),h.jsxs(Kl,{children:[h.jsx(Jl,{color:"#ff8800",children:"USG"}),h.jsx(Wl,{children:"155-254"})]}),h.jsxs(Kl,{children:[h.jsx(Jl,{color:"#ff1a1a",children:"Unhealthy"}),h.jsx(Wl,{children:"255-354"})]}),h.jsxs(Kl,{children:[h.jsx(Jl,{color:"#9933ff",children:"Very Unhealthy"}),h.jsx(Wl,{children:"355-424"})]}),h.jsxs(Kl,{children:[h.jsx(Jl,{color:"#990033",children:"Hazardous"}),h.jsx(Wl,{children:"425+"})]})]})]}),h.jsx(Ib,{children:'Note: USG stands for "Unhealthy for Sensitive Groups" - including children, older adults, and people with respiratory or heart conditions.'})]})]})]}),o==="howto"&&h.jsxs(Vb,{children:[h.jsxs(Kb,{children:[h.jsx(Uu,{children:"Quick Start Guide"}),h.jsx(Hu,{}),h.jsxs(tv,{children:[h.jsxs(ri,{children:[h.jsx(ci,{children:"1"}),h.jsxs(si,{children:[h.jsx(fi,{children:"Navigate the map"}),h.jsx(di,{children:"Use standard zoom and pan controls located on the left side of the screen."})]})]}),h.jsxs(ri,{children:[h.jsx(ci,{children:"2"}),h.jsxs(si,{children:[h.jsx(fi,{children:"Choose lake elevation"}),h.jsx(di,{children:"Select different GSL elevation scenarios to see how dust emissions change."})]})]}),h.jsxs(ri,{children:[h.jsx(ci,{children:"3"}),h.jsxs(si,{children:[h.jsx(fi,{children:"Use timeline controls"}),h.jsx(di,{children:"Play through the forecast timeline or choose a specific date/time."})]})]}),h.jsxs(ri,{children:[h.jsx(ci,{children:"4"}),h.jsxs(si,{children:[h.jsx(fi,{children:"View emissions levels"}),h.jsx(di,{children:"Mouse over colored areas to see specific PM10 concentration values."})]})]}),h.jsxs(ri,{children:[h.jsx(ci,{children:"5"}),h.jsxs(si,{children:[h.jsx(fi,{children:"Toggle map layers"}),h.jsx(di,{children:"Use the layer control to customize your view and see different data visualizations."})]})]})]}),h.jsxs(ev,{children:[h.jsx(Ag,{size:24,className:"mr-4 text-mahogany flex-shrink-0"}),h.jsx("div",{children:"Need more help? A detailed guided tour is available by clicking the help button in the bottom-right corner of the map interface."})]})]}),h.jsxs(av,{children:[h.jsx(lv,{children:h.jsx("h2",{children:"Video Tutorial"})}),h.jsxs(nv,{children:[h.jsx(iv,{children:h.jsx(uv,{children:h.jsx(jb,{size:40,className:"ml-1"})})}),h.jsx(ov,{children:"(Video would be embedded here)"})]}),h.jsx(rv,{children:h.jsxs("div",{children:[h.jsx(cv,{children:"Introduction to GSL Dust Tool"}),h.jsx(sv,{children:"Duration: 4:30"})]})})]})]}),o==="feedback"&&h.jsxs(Yu,{wide:!0,children:[h.jsx(Uu,{children:"Submit Feedback"}),h.jsx(Hu,{}),h.jsxs(fv,{children:[h.jsxs(dv,{children:[h.jsx(Sb,{size:24,className:"mr-3"}),h.jsx(hv,{children:"GitHub Issues"})]}),h.jsx(wg,{children:"For bug reports, feature requests, and technical feedback, please submit a GitHub issue. This helps us track and address your concerns effectively."}),h.jsxs(gv,{children:[h.jsx(mv,{children:"github.com/wilkes-center/gsl-dust-tool/issues"}),h.jsx(pv,{href:"https://github.com/wilkes-center/gsl-dust-tool/issues",target:"_blank",rel:"noopener noreferrer",children:"Submit Issue"})]})]})]})]})]})]})},Rb=R.div`
  position: fixed;
  inset: 0;
...
`,Ac=R.button`  padding: 0.75rem 2rem;
